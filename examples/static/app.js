...
//     // Specific listener for Kafka events
...
//     // Listener for text events from Redis
...
//     // Listener for JSON broadcast events from Redis
//     socket.on('json_broadcast_event', (data) => {
//         console.log('JSON Broadcast message Received:', data);
//         messagesDiv.innerHTML += `<p>JSON Broadcast Event: ${JSON.stringify(data)}</p>`;
//     });

//     // Listener for broadcast events specifically from Kafka
